"""Flask application for OLASIS 4.0 - Version without chatbot for testing."""
...
def _cookie_policy_url() -> str:
    """Return the cookie policy URL, even if decorators were skipped."""
...
def inject_cookie_policy_url():
    """Provide the cookie policy link to templates."""
...
if __name__ == "__main__":
    ...
    print(f"Starting OLASIS 4.0 on port {port}")
